...
(function (global) {
  ...
  var PALETTES = [
    ...
    { id: 'outrun',  name: 'OUTRUN',  colors: ['#ff006e', '#8338ec', '#3a86ff', '#fb5607', '#ffbe0b', '#c11cad', '#00d4ff', '#ff4d6d'] },
    { id: 'toxic',   name: 'TOXIC',   colors: ['#39ff14', '#00ffc8', '#ccff00', '#00e5ff', '#7cff00', '#00ff8c', '#b6ff00', '#22ffdd'] },
    { id: 'inferno', name: 'INFERNO', colors: ['#ff2200', '#ff6a00', '#ffb300', '#ff0055', '#ff8c00', '#ffd000', '#ff3d00', '#ff0080'] },
    { id: 'ice',     name: 'ICE',     colors: ['#00e5ff', '#4dd0ff', '#7aa2ff', '#b388ff', '#00b4d8', '#5eead4', '#8ecdf7', '#c3b1ff'] },
    { id: 'vapor',   name: 'VAPOR',   colors: ['#ff9ec7', '#a0e9ff', '#c4a0ff', '#ffd6a0', '#9fffcb', '#ffb3de', '#a7c6ff', '#ffc8f0'] },
    { id: 'sunset',  name: 'SUNSET',  colors: ['#ff5f6d', '#ffc371', '#ff9a44', '#fc4a1a', '#f7b733', '#ff6f61', '#ffae42', '#ff4e50'] },
  ...
  var Settings = {
    FONTS: FONTS, PALETTES: PALETTES, SIZES: SIZES,
